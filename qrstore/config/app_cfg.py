# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in qr-store.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': qrstore.model,
    'DBSession': qrstore.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "b185e80e-b1a7-417c-883c-8ddcbaf5ee81",
